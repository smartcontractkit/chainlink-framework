...
type mockSendOnlyClient[CHAIN_ID ID] struct {
	mock.Mock
}

type mockSendOnlyClient_Expecter[CHAIN_ID ID] struct {
	mock *mock.Mock
}
...
type mockSendOnlyClient_ChainID_Call[CHAIN_ID ID] struct {
	*mock.Call
}
...
type mockSendOnlyClient_Close_Call[CHAIN_ID ID] struct {
	*mock.Call
}
...
type mockSendOnlyClient_Dial_Call[CHAIN_ID ID] struct {
	*mock.Call
}
...
func newMockSendOnlyClient[CHAIN_ID ID](t interface {
	mock.TestingT
	Cleanup(func())
