...
type mockRPCClient[CHAIN_ID ID, HEAD Head] struct {
	mock.Mock
}

type mockRPCClient_Expecter[CHAIN_ID ID, HEAD Head] struct {
	mock *mock.Mock
}
...
type mockRPCClient_ChainID_Call[CHAIN_ID ID, HEAD Head] struct {
	*mock.Call
}
...
type mockRPCClient_Close_Call[CHAIN_ID ID, HEAD Head] struct {
	*mock.Call
}
...
type mockRPCClient_Dial_Call[CHAIN_ID ID, HEAD Head] struct {
	*mock.Call
}
...
type mockRPCClient_GetInterceptedChainInfo_Call[CHAIN_ID ID, HEAD Head] struct {
	*mock.Call
}
...
type mockRPCClient_Ping_Call[CHAIN_ID ID, HEAD Head] struct {
	*mock.Call
}
...
func (_m *mockRPCClient[CHAIN_ID, HEAD]) SubscribeToFinalizedHeads(ctx context.Context) (<-chan HEAD, Subscription, error) {
	ret := _m.Called(ctx)
	...
	var r1 Subscription
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context) (<-chan HEAD, Subscription, error)); ok {
		return rf(ctx)
	}
	...
	if rf, ok := ret.Get(1).(func(context.Context) Subscription); ok {
		r1 = rf(ctx)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(Subscription)
		}
	}
...
type mockRPCClient_SubscribeToFinalizedHeads_Call[CHAIN_ID ID, HEAD Head] struct {
	*mock.Call
}
...
func (_c *mockRPCClient_SubscribeToFinalizedHeads_Call[CHAIN_ID, HEAD]) Return(_a0 <-chan HEAD, _a1 Subscription, _a2 error) *mockRPCClient_SubscribeToFinalizedHeads_Call[CHAIN_ID, HEAD] {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *mockRPCClient_SubscribeToFinalizedHeads_Call[CHAIN_ID, HEAD]) RunAndReturn(run func(context.Context) (<-chan HEAD, Subscription, error)) *mockRPCClient_SubscribeToFinalizedHeads_Call[CHAIN_ID, HEAD] {
	_c.Call.Return(run)
	return _c
}

// SubscribeToHeads provides a mock function with given fields: ctx
func (_m *mockRPCClient[CHAIN_ID, HEAD]) SubscribeToHeads(ctx context.Context) (<-chan HEAD, Subscription, error) {
	ret := _m.Called(ctx)
...
type mockRPCClient_SubscribeToHeads_Call[CHAIN_ID ID, HEAD Head] struct {
	*mock.Call
}
...
func (_c *mockRPCClient_SubscribeToHeads_Call[CHAIN_ID, HEAD]) Return(_a0 <-chan HEAD, _a1 Subscription, _a2 error) *mockRPCClient_SubscribeToHeads_Call[CHAIN_ID, HEAD] {
	_c.Call.Return(_a0, _a1, _a2)
	return _c
}

func (_c *mockRPCClient_SubscribeToHeads_Call[CHAIN_ID, HEAD]) RunAndReturn(run func(context.Context) (<-chan HEAD, Subscription, error)) *mockRPCClient_SubscribeToHeads_Call[CHAIN_ID, HEAD] {
	_c.Call.Return(run)
	return _c
}

// UnsubscribeAllExcept provides a mock function with given fields: subs
func (_m *mockRPCClient[CHAIN_ID, HEAD]) UnsubscribeAllExcept(subs ...Subscription) {
...
type mockRPCClient_UnsubscribeAllExcept_Call[CHAIN_ID ID, HEAD Head] struct {
	*mock.Call
}
...
func (_c *mockRPCClient_UnsubscribeAllExcept_Call[CHAIN_ID, HEAD]) Run(run func(subs ...Subscription)) *mockRPCClient_UnsubscribeAllExcept_Call[CHAIN_ID, HEAD] {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]Subscription, len(args)-0)
		for i, a := range args[0:] {
			if a != nil {
				variadicArgs[i] = a.(Subscription)
			}
		}
		run(variadicArgs...)
	})
...
func (_c *mockRPCClient_UnsubscribeAllExcept_Call[CHAIN_ID, HEAD]) RunAndReturn(run func(...Subscription)) *mockRPCClient_UnsubscribeAllExcept_Call[CHAIN_ID, HEAD] {
	_c.Run(run)
	return _c
}
