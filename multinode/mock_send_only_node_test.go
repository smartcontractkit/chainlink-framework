...
type mockSendOnlyNode[CHAIN_ID ID, RPC any] struct {
	mock.Mock
}

type mockSendOnlyNode_Expecter[CHAIN_ID ID, RPC any] struct {
	mock *mock.Mock
}
...
type mockSendOnlyNode_Close_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
type mockSendOnlyNode_ConfiguredChainID_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
type mockSendOnlyNode_Name_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
type mockSendOnlyNode_RPC_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
type mockSendOnlyNode_Start_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
type mockSendOnlyNode_State_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
type mockSendOnlyNode_String_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
func newMockSendOnlyNode[CHAIN_ID ID, RPC any](t interface {
	mock.TestingT
	Cleanup(func())
