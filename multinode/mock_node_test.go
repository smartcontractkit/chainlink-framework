...
type mockNode[CHAIN_ID ID, RPC any] struct {
	mock.Mock
}

type mockNode_Expecter[CHAIN_ID ID, RPC any] struct {
	mock *mock.Mock
}
...
type mockNode_Close_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
type mockNode_ConfiguredChainID_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
type mockNode_HighestUserObservations_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
type mockNode_Name_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
type mockNode_Order_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
type mockNode_RPC_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
type mockNode_SetPoolChainInfoProvider_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
type mockNode_Start_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
type mockNode_State_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
type mockNode_StateAndLatest_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
type mockNode_String_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
type mockNode_UnsubscribeAllExceptAliveLoop_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
func newMockNode[CHAIN_ID ID, RPC any](t interface {
	mock.TestingT
	Cleanup(func())
