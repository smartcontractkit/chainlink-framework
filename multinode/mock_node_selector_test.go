...
type mockNodeSelector[CHAIN_ID ID, RPC any] struct {
	mock.Mock
}

type mockNodeSelector_Expecter[CHAIN_ID ID, RPC any] struct {
	mock *mock.Mock
}
...
type mockNodeSelector_Name_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
type mockNodeSelector_Select_Call[CHAIN_ID ID, RPC any] struct {
	*mock.Call
}
...
func newMockNodeSelector[CHAIN_ID ID, RPC any](t interface {
	mock.TestingT
	Cleanup(func())
