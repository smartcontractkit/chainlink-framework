...
type mockNodeSelector[CHAIN_ID ID, RPC interface{}] struct {
	mock.Mock
}

type mockNodeSelector_Expecter[CHAIN_ID ID, RPC interface{}] struct {
	mock *mock.Mock
}
...
type mockNodeSelector_Name_Call[CHAIN_ID ID, RPC interface{}] struct {
	*mock.Call
}
...
type mockNodeSelector_Select_Call[CHAIN_ID ID, RPC interface{}] struct {
	*mock.Call
}
...
func newMockNodeSelector[CHAIN_ID ID, RPC interface{}](t interface {
	mock.TestingT
	Cleanup(func())
