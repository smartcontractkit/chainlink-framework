...
func (x *WriteSkipped) GetExecutionContext() *monitoring.ExecutionContext {
	if x != nil {
...
const file_write_skipped_proto_rawDesc = "" +
	...
	"\x06reason\x18\x05 \x01(\tR\x06reason\x12I\n" +
...
var file_write_skipped_proto_depIdxs = []int32{
	1, // 0: platform.write_target.WriteSkipped.execution_context:type_name -> monitoring.ExecutionContext
