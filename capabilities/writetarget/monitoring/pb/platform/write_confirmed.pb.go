...
type WriteConfirmed struct {
	...
	MetaCapabilityProcessor string `protobuf:"bytes,36,opt,name=meta_capability_processor,json=metaCapabilityProcessor,proto3" json:"meta_capability_processor,omitempty"`
...
const file_write_confirmed_proto_rawDesc = "" +
	"\n" +
	"\x15write_confirmed.proto\x12\x15platform.write_target\"\xf4\t\n" +
	...
	"\x1emeta_capability_timestamp_emit\x18# \x01(\x04R\x1bmetaCapabilityTimestampEmit\x12:\n" +
