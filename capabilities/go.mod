...
require (
	github.com/smartcontractkit/chainlink-common v0.6.1-0.20250407224055-654b33960acc
	github.com/smartcontractkit/chainlink-evm/capabilities v0.0.0-20250407230636-a68528440eb2
